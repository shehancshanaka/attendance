...
if(!isset($_SESSION['user_id']) || !isset($_SESSION['role_name']) || $_SESSION['role_name'] !== 'supervisor') {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && isset($_POST['leave_id'])) {
        ...
        header("Location: supervisor_leaves.php");
        exit();
    }
}

// Get supervised employees' leave requests
$supervised_leaves = $leave->getSupervisedLeaves($_SESSION['user_id']);
?>
...
<head>
    ...
    <title>Manage Employee Leaves - Supervisor Panel</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="supervisor_leaves.php">
                            <i class="fas fa-calendar-alt me-2"></i> Employee Leaves
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if (empty($supervised_leaves)): ?>
                                        <tr>
                                            <td colspan="7" class="text-center">No leave requests found for your supervised employees.</td>
                                        </tr>
                                    <?php else: ?>
                                        <?php foreach ($supervised_leaves as $leave): ?>
                                            <tr>
